...
import shop.tv.rsys.com.tvapplication.player.MediaPlayerActivity;
...
public class VideoDetailsFragment extends DetailsFragment {
    ...
    private void setupDetailsOverviewRow() {
        ...
        String rentCost = "0.0";
        if(mSelectedMovie.getRentalItems()!=null) {
            rentCost = mSelectedMovie.getRentalItems().getRentalCost();
            row.addAction(new Action(ACTION_RENT, getResources().getString(R.string.rent_1),
                    getResources().getString(R.string.rent_2)+rentCost));
        }
