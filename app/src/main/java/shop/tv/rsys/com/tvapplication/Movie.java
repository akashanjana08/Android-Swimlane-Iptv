...
public class Movie implements Serializable {
    ...
    private BtaResponseModel.RentalItem rentalItems;

    public Movie() {
    }


    public BtaResponseModel.RentalItem getRentalItems() {
        return rentalItems;
    }

    public void setRentalItems(BtaResponseModel.RentalItem rentalItems) {
