 ...
 */
class MyItemAlignment {

    final static class Axis extends MyItemAlignmentFacet.ItemAlignmentDef {
        ...
        public int getAlignmentPosition(View itemView) {
            return MyItemAlignmentFacetHelper.getAlignmentPosition(itemView, this, mOrientation);
        }
    }
