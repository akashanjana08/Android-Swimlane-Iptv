 ...
 */
class MyItemAlignmentFacetHelper {
     ...
     */
    static int getAlignmentPosition(View itemView, MyItemAlignmentFacet.ItemAlignmentDef facet,
                                    int orientation) {
        MyGridLayoutManager.LayoutParams p = (MyGridLayoutManager.LayoutParams) itemView.getLayoutParams();
        View view = itemView;
        if (facet.mViewId != 0) {
