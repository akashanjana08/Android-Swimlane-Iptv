 ...
 * </ol>
 */
public class MyHorizontalGridView extends MyBaseGridView {
    ...
    public MyHorizontalGridView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyHorizontalGridView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void initAttributes(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, android.support.v17.leanback.R.styleable.lbHorizontalGridView);
        setRowHeight(a);
        setNumRows(a.getInt(android.support.v17.leanback.R.styleable.lbHorizontalGridView_numberOfRows, 1));
        a.recycle();
        updateLayerType();
    ...
    void setRowHeight(TypedArray array) {
        TypedValue typedValue = array.peekValue(android.support.v17.leanback.R.styleable.lbHorizontalGridView_rowHeight);
        if (typedValue != null) {
            int size = array.getLayoutDimension(android.support.v17.leanback.R.styleable.lbHorizontalGridView_rowHeight, 0);
            setRowHeight(size);
        }
    }
